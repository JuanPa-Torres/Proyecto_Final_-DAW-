<div class="container">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <form
                action="<?= base_url('/administrador/caracteristicas/editar/' . $caracteristicas->idCaracteristicas); ?>"
                method="POST">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Talla_Cuadro"
                        value="<?= $caracteristicas->Talla_Cuadro ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Colores_Disponibles" id="Colores_Disponibles"
                        value="<?= $caracteristicas->Colores_Disponibles ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Geometrias"
                        value="<?= $caracteristicas->Geometrias ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Limite_Peso"
                        value="<?= $caracteristicas->Limite_Peso ?>">
                </div>
