<div class="container">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <form action="<?= base_url('/administrador/componentes/editar/' . $componentes->idComponentes); ?>"
                method="POST">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Amortiguador" id="Amortiguador"
                        value="<?= $componentes->Amortiguador ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Ruedas_Delanteras" id="Ruedas_Delanteras"
                        value="<?= $componentes->Ruedas_Delanteras ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Cambio_Delantero" id="Cambio_Delantero"
                        value="<?= $componentes->Cambio_Delantero ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Rotores_Frenos" id="Rotores_Frenos"
                        value="<?= $componentes->Rotores_Frenos ?>">
                </div>
