...
<div class="container">
    <div class="row">
        ...
        <div class="col-12">
            <h1 align="center">Bienvenido, administrador
                <?= $session->get('Nombre') ?>
            </h1>
        ...
        <div class="col-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-success" onclick="location.href='/administrador/usuario'">Ir a
                        Usuarios</button>
            ...
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <img src="https://images.vexels.com/media/users/3/153529/isolated/preview/7bc69f401f0d4ac00f7a08bc28fba2e2-icono-de-trazo-de-bicicleta.png"
                        width="100"><br>
                    <button type="button" class="btn btn-success" onclick="location.href='/administrador/bicicletas'">Ir
                        a Bicicletas</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-success" onclick="location.href='/administrador/marca'">Ir a
                        Marcas</button>
        ...
        <div class="col-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-success" onclick="location.href='/administrador/modelo'">Ir a
                        Modelos</button>
